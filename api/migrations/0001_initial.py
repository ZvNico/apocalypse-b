    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(blank=True, help_text="separate each content with '|' (AC Valhalla|AC Valhalla: Aube du Ranarok)", null=True, verbose_name='contenus')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('edition', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='keys', to='api.edition', verbose_name='édition')),
            ],
        ),
        migrations.CreateModel(
            name='Game',
