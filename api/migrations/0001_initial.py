# Generated by Django 4.0.5 on 2022-06-13 10:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('edition', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.edition', verbose_name='édition')),
            ],
        ),
        migrations.AddField(
            model_name='edition',
            name='game',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.game', verbose_name='jeu'),
        ),
        migrations.CreateModel(
            name='Cart',
            fields=[
        ...
        migrations.AddField(
            model_name='game',
            name='editor',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.editor', verbose_name='editeur'),
        ),
        migrations.AddField(
            model_name='game',
            name='genres',
        ...
        migrations.AddField(
            model_name='edition',
            name='platform',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.platform', verbose_name='plateforme'),
        ),
    ]
